...
2026-08-30 고성·속초·양양 4곳 현장 확인 결과 예전 엔진이 70~80점을 준 날의 실제 바다는
장판·코앞붕괴·챠피였습니다. 그날 너울 주기는 **4.8초**. 재설계 후:

| 스팟 | 이전 | 현재 | 실제 |
|---|---|---|---|
| 천진 | 80 | **3** | 파도 한 점 없는 장판 |
| 봉수대 | 78 | **17** | 코앞에서 컬 → 즉시 붕괴 |
| 설악 | 72 | **14** | 매우 챠피·지저분 |
| 물치 | 70 | **14** | 그럭저럭 (로컬 40/100) |

관측 기록은 [`src/data/fieldReports.ts`](src/data/fieldReports.ts) 에 남깁니다 —
9km 격자가 볼 수 없는 로컬 차폐·수심은 **현장 관측 말고는 보정할 방법이 없습니다.**
